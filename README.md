...
The [https://github.com/codurance/SalarySlipKata/blob/master/DETAILS.md](DETAILS.md) file contains a condensed version of the calculation rules with more examples and links to additional resources.
